...
interface QuickBillPayProps {
  className?: string
}

export function QuickBillPay({ className }: QuickBillPayProps) {
  ...
  return (
    <Card className={cn("h-full", className)}>
      <CardHeader>
        <CardTitle className="text-base font-semibold">Quick Bill Pay</CardTitle>
      </CardHeader>
      <CardContent>
        {bills.length > 0 ? (
